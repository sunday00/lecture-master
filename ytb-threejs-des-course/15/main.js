...
import { AnaglyphEffect } from "../lib/node_modules/three/examples/jsm/effects/AnaglyphEffect.js";
...
function init() {
   ...
   * effects
   */
  effects[0] = new AnaglyphEffect(renderer);
  effects[0].setSize(window.innerWidth, window.innerHeight);
