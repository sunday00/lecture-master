...
static PyObject *__pyx_f_5hello_cython_add(int, int, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_pf_5hello_2cython_add(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_num1, int __pyx_v_num2); /* proto */
...
static PyObject *__pyx_pw_5hello_3cython_add(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_5hello_cython_add(int __pyx_v_num1, int __pyx_v_num2, CYTHON_UNUSED int __pyx_skip_dispatch) {
 ...
 */
  ...
  __pyx_t_7 = __Pyx_PyInt_From_PY_LONG_LONG(__pyx_v_result); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 12, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("hello.cython_add", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_5hello_3cython_add(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_5hello_3cython_add(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_num1;
  int __pyx_v_num2;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  ...
  __Pyx_RefNannySetupContext("cython_add (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "cython_add") < 0)) __PYX_ERR(0, 6, __pyx_L3_error)
      }
    ...
    __pyx_v_num1 = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_num1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_num2 = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_num2 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("cython_add", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 6, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("hello.cython_add", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5hello_2cython_add(__pyx_self, __pyx_v_num1, __pyx_v_num2);
...
static PyObject *__pyx_pf_5hello_2cython_add(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_num1, int __pyx_v_num2) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_RefNannySetupContext("cython_add", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_5hello_cython_add(__pyx_v_num1, __pyx_v_num2, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"cython_add", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5hello_3cython_add, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
