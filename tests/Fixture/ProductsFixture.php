...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'stocks' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'manufacturer' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        ...
        'modified_at' => ['type' => 'datetime', 'length' => null, 'precision' => null, 'null' => false, 'default' => null, 'comment' => ''],
        ...
        '_constraints' => [
            ...
            'products_ibfk_1' => ['type' => 'foreign', 'columns' => ['category_id'], 'references' => ['categories', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'price' => 1,
                'created_at' => '2021-05-10 03:15:22',
                'modified_at' => '2021-05-10 03:15:22',
                'category_id' => 1,
            ],
        ];
        parent::init();
