...
class StudentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'country' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created_at' => '2021-05-07 02:42:07',
                'modified_at' => '2021-05-07 02:42:07',
            ],
        ];
        parent::init();
    }
