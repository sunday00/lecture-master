...
import { CommonStateType } from '../type';
  ...
  export const actions = {
    ...
    setIsSlow: (payload: any) => ({ type: Types.SetIsSlow, payload }),
    setFetchStatus: (payload: any) => ({ type: Types.SetFetchStatus, payload }),
  };
  ...
  const reducer = createReducer(INITIAL_STATE, {
    ...
    [Types.SetFetchStatus]: (state: CommonStateType, action: { payload: { actionType: any; fetchKey: any; status: any; totalCount: any; nextPage: any; errorMessage: any; }; }) => {
      const {
        actionType,
        fetchKey,
        status,
    ...
    [Types.SetIsSlow]: (state: { fetchInfo: { isSlowMap: { [x: string]: { [x: string]: any; }; }; }; }, action: { payload: { actionType: any; fetchKey: any; isSlow: any; }; }) => {
